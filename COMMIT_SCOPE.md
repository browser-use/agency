...
| Portable setup | Current Agency skill with bundled writing references; Codex/Claude Code installer; configurable profile path; fresh-profile sync; setup and safety instructions. |
